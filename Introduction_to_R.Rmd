...
After these operations, we have purely numeric coordinate columns, with coordinates belonging to the Eastern hemisphere expressed as negatives. The code below extracts a 3-column subset of the original data.frame via column name selection.
...
which repeats each element of the input vector three times before moving on to the next.
