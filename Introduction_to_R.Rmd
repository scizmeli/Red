...
We also have to perform a similar operation on the Year column to make the column entirely *numeric*, i.e. *class(maps$Year)* becomes equal to *`r class(maps$Year)`*
```{r}
