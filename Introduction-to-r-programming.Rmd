...
Now you can open the file for inspection or share it with others.
...
as.matrix(sapply(js$data[,3:15], function(x) as.numeric(x)))

as.matrix(sapply(js$data[,3:15], as.numeric))
```
...
## GIS data formats
R packages *rgdal* and *sf* offer interfaces for reading/writing various types of geospatial data formats. as.matrix(sapply(js$data[,3:15], function(x) as.numeric(x)))
ite data from/to Excel files|
| png::writePNG(), jpeg::writeJPEG(), tiff::writeTIFF()| Export RGB images|
...
## GIS data formats
R packages *rgdal* and *sf* offer interfaces for reading/writing various types of geospatial data formats.  | Read and wras.matrix(sapply(js$data[,3:15], function(x) as.numeric(x)))
ite data from/to Excel files|
| png::writePNG(), jpeg::writeJPEG(), tiff::writeTIFF()| Export RGB images|
